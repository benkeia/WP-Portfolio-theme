            ...
            <button id="one" class="key keypad__single keypad__single--left">
                <span class="key__mask">
                    <span class="key__content">
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/resources/images/keypad/keypad-single.png"
                            alt="" />
                    </span>
                </span>
            </button>
            ...
            <button id="three" class="key keypad__double">
                <span class="key__mask">
                    <span class="key__content">
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/resources/images/keypad/keypad-double.png"
                            alt="" />
                    </span>
                </span>
            </button>
