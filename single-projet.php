...
<main data-barba="container" data-barba-namespace="project-<?php echo get_post_field('post_name', get_post()); ?>">
    ...
    <article class="bg-neutral-900 min-h-screen">
        ...
        <section class="w-full pt-12 pb-12 px-4 md:px-24">
            <div class="w-full max-w-[1200px] mx-auto">
                <div class="flex flex-col gap-3 mb-12 pb-8 border-b border-neutral-800">
                    ...
                    <div class="overflow-hidden">
                        <div class="w-full max-w-[1200px] flex justify-start">
                            <div class="w-full max-w-[1200px] mx-auto flex justify-start">
                                <div class="relative w-full max-w-[1200px] flex justify-start">
